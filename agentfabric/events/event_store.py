...
EVENT_TYPE_REGISTRY = {
    ...
    "renovation.mvp.run.created",
    "renovation.mvp.step.started",
    "renovation.mvp.step.completed",
    "renovation.mvp.step.failed",
    "renovation.mvp.run.completed",
    "renovation.mvp.run.failed",
    "renovation.mvp.run.replayed",
    "renovation.mvp.run.resumed",
    "renovation.mvp.invoice_payment.generated",
    "renovation.mvp.portal_status.viewed",
    ...
    "renovation.operator.account.role_assigned",
    "renovation.operator.settings.updated",
    "renovation.operator.proposal.pdf_exported",
    "renovation.operator.invoice.pdf_exported",
    "renovation.operator.attachment.created",
    "renovation.operator.attachment.downloaded",
    "renovation.operator.attachment.archived",
    "renovation.operator.notification.send_attempted",
    "renovation.operator.notification.queued",
    ...
    "renovation.operator.schedule.synced",
    "renovation.operator.payment_link.created",
    "renovation.operator.payment_status.updated",
